						...
						<li class="nav-item">
							...
							<div class="collapse" id="sidebarLayouts">
								<ul class="nav nav-collapse">
									<li>
										<a href="citas/" target="myFrame">
											<span class="sub-item">Generar Cita</span>
										</a>
									</li>
									<li>
										<a href="#">
											<span class="sub-item">Estado de la cita</span>
										</a>
									</li>
									<li>
										<a href="#">
											<span class="sub-item">Detalles de la cita</span>
										</a>
									</li>
								</ul>
							</div>
