	    ...
	    <div class="modal-dialog modal-dialog-centered" role="document">
	      <div class="modal-content">
	        ...
	        <div class="modal-body">
	        	Seguro de eliminar Especialidad? 
	        </div>
...
<div class="col-md-12">
		...
		<div class="d-flex align-items-center">
	 	<h4 class="card-title">Listado de Tipos de Empleados</h4>
		...
		<div class="table-responsive">
			<table id="table" class="display table table-striped table-hover">
		        ...
		        <tbody>
				<c:forEach items="${requestScope.dataTipoEmpleados}" var="row">
		            <tr>
		                <td>${row.codigoTipoEmpleado}</td>
		                <td>${row.nombreTipoEmpleado}</td>
		                ...
		                <div class="form-button-action">
											...
											<a href="delete/${row.codigoTipoEmpleado}" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Eliminar" id="eliminar">
		...
		<div class="modal fade" id="modalCliente" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
		  <div class="modal-dialog">
		    <div class="modal-content">
		      <div class="modal-header">
		        <h5 class="modal-title" id="idTitulo">REGISTRAR TIPO EMPLEADO</h5>
		      </div>
		      <div class="modal-body">
...
$(document).on("click","#btnEditar",function(){
	...
	.then(tipoempleado=>{
		...
		$("#codigo").val(tipoempleado.codigoTipoEmpleado);
		$("#nombre").val(tipoempleado.nombreTipoEmpleado);
	})
	
	$("#idTitulo").text("ACTUALIZAR TIPO EMPLEADO");
...
$(document).on("click","#cerrar",function(){
	...
	$("#codigo").val("0");		
	$("#idTitulo").text("REGISTRAR TIPO EMPLEADO");
