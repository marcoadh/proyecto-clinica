...
<div class="col-md-12">
		...
		<i class="fa fa-plus"></i> Nuevo Medicamento
		</button>
		</div>
		</div> 
		<div class="card-body">
		<div class="table-responsive">
			<table id="table" class="display table table-striped table-hover">
		        ...
		        <tbody>
				<c:forEach items="${requestScope.dataMedicamentos}" var="row">
		            <tr>
		                <td>${row.codigoMedicamento}</td>
		                <td>${row.nombre}</td>
		                ...
		                <div class="form-button-action">
											...
											<a href="delete/${row.codigoMedicamento}" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Eliminar" id="eliminar">
		...
		<div class="modal fade" id="modalCliente" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
		  <div class="modal-dialog">
		    <div class="modal-content">
		      <div class="modal-header">
		        <h5 class="modal-title" id="idTitulo">REGISTRAR MEDICAMENTO</h5>
		      </div>
		      <div class="modal-body">
		        <form id="frmCliente" action="save" method="post" data-toggle="validator" role="form">
				  ...
				  <div class="form-group">
				    <label for="exampleInputEmail1">Concentracion</label>
...
$(document).on("click","#btnEditar",function(){
	...
	.then(medicamento=>{
		...
		$("#codigo").val(medicamento.codigoMedicamento);
		$("#nombre").val(medicamento.nombre);
		$("#concentracion").val(medicamento.concentracion);
		$("#presentacion").val(medicamento.presentacion);	
	})
	
	$("#idTitulo").text("ACTUALIZAR MEDICAMENTO");
...
$(document).on("click","#cerrar",function(){
	...
	$("#codigo").val("0");		
	$("#idTitulo").text("REGISTRAR MEDICAMENTO");
