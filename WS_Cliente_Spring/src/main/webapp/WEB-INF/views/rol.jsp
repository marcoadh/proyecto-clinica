...
<div class="col-md-12">
		...
		<div class="table-responsive">
			<table id="table" class="display table table-striped table-hover">
		        ...
		        <tbody>
				<c:forEach items="${requestScope.dataRoles}" var="row">
		            <tr>
		                <td>${row.idRol}</td>
		                ...
		                <div class="form-button-action">
											...
											<a href="delete/${row.idRol}" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Eliminar" id="eliminar">
		...
		<div class="modal fade" id="modalCliente" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
		  <div class="modal-dialog">
		    <div class="modal-content">
		      <div class="modal-header">
		        <h5 class="modal-title" id="idTitulo">REGISTRAR ROL</h5>
		      </div>
		      <div class="modal-body">
...
$(document).on("click","#btnEditar",function(){
	...
	.then(rol=>{
		...
		$("#codigo").val(rol.idRol);
		$("#nombre").val(rol.descripcion);
	})
	
	$("#idTitulo").text("ACTUALIZAR ROL");
