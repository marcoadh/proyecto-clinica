...
<div class="col-md-12">
		...
		<div class="table-responsive">
			<table id="table" class="display table table-striped table-hover">
		        ...
		        <tbody>
				<c:forEach items="${requestScope.dataDistritos}" var="row">
		            <tr>
		                <td>${row.codigoDistrito}</td>
		                <td>${row.nombre}</td>
		                ...
		                <div class="form-button-action">
											...
											<a href="delete/${row.codigoDistrito}" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Eliminar" id="eliminar">
		...
		<div class="modal fade" id="modalCliente" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
		  <div class="modal-dialog">
		    <div class="modal-content">
		      <div class="modal-header">
		        <h5 class="modal-title" id="idTitulo">REGISTRAR DISTRITO</h5>
		      </div>
		      <div class="modal-body">
...
$(document).on("click","#btnEditar",function(){
	...
	.then(distrito=>{
		...
		$("#codigo").val(distrito.codigoDistrito);
		$("#nombre").val(distrito.nombre);
	})
	
	$("#idTitulo").text("ACTUALIZAR DISTRITO");
...
$(document).on("click","#cerrar",function(){
	...
	$("#codigo").val("0");		
	$("#idTitulo").text("REGISTRAR DISTRITO");
