...
<div class="col-md-12">
		...
		<div class="table-responsive">
			<table id="table" class="display table table-striped table-hover">
		        ...
		        <tbody>
				<c:forEach items="${requestScope.dataClientes}" var="row">
		            <tr>
		                ...
		                <div class="form-button-action">
											...
											<a href="delete/${row.codigoCliente}" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Eliminar" id="eliminar">
		...
		<div class="modal fade" id="modalCliente" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
		  <div class="modal-dialog">
		    <div class="modal-content">
		      <div class="modal-header">
		        <h5 class="modal-title" id="idTitulo">REGISTRAR CLIENTES</h5>
		      </div>
		      <div class="modal-body">
...
$(document).on("click","#btnEditar",function(){
	...
	.then(cliente=>{
		...
		$("#codigo").val(cliente.codigoCliente);
		$("#dni").val(cliente.dni);
	...
	$("#idTitulo").text("ACTUALIZAR CLIENTE");
