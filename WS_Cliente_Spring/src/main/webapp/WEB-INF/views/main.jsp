...
<div class="wrapper">
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="index.html" class="logo">
					<img src="<c:url value="/resources/img/logo.svg" />"alt="navbar brand" class="navbar-brand">
				</a>
				...
				<div class="sidebar-content">
					<div class="user">
						<div class="avatar-sm float-left mr-2">
							<img src="<c:url value="/resources/img/profile.jpg" />" alt="..." class="avatar-img rounded-circle">
						</div>
						<div class="info">
							...
							<a data-toggle="collapse" href="#collapseExample" aria-expanded="true">
								<span>
									<span class="user-level">${sessionScope.dataUsuario.empleado.nombres}, </span>
									<span class="user-level">${sessionScope.dataUsuario.empleado.apellidos} </span>
									
									
									<span class="user-level">${sessionScope.dataUsuario.rol.descripcion}</span>
					...
					<ul class="nav nav-primary">
						...
						<c:forEach items="${sessionScope.dataEnlaces}" var="row">
						    <li class="nav-item">
						      <a class="nav-link" href="${row.ruta}"  target="myFrame">
						      	<i class="fa fa-circle-o-notch"></i>${row.descripcion}
						      </a>
						    </li>
						</c:forEach>
				...
				<div class="panel-header bg-primary-gradient">
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h5 class="text-white pb-2 fw-bold"></h5>
							</div>
						</div>
					</div>				
				</div>
				<div class="embed-responsives m-4" style="height: 870px;">
             <iframe class="embed-responsive-item" name="myFrame" style="height: 100%; width: 95%; border:navy"></iframe>                
            </div>
	...
	<script src="<c:url value="/resources/js/setting-demo.js" />"></script>
