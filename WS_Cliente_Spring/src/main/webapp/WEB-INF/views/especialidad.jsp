...
<div class="col-md-12">
		...
		<div class="d-flex align-items-center">
	 	<h4 class="card-title">Listado de Especialidades</h4>
		...
		<div class="table-responsive">
			<table id="table" class="display table table-striped table-hover">
		        ...
		        <tbody>
				<c:forEach items="${requestScope.dataEspecialidades}" var="row">
		            <tr>
		                ...
		                <div class="form-button-action">
											...
											<a href="delete/${row.codigoEspecialidad}" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Eliminar" id="eliminar">
		...
		<div class="modal fade" id="modalCliente" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
		  <div class="modal-dialog">
		    <div class="modal-content">
		      <div class="modal-header">
		        <h5 class="modal-title" id="idTitulo">REGISTRAR ESPECIALIDAD</h5>
		      </div>
		      <div class="modal-body">
...
$(document).on("click","#btnEditar",function(){
	...
	.then(especialidad=>{
		...
		$("#codigo").val(especialidad.codigoEspecialidad);
		$("#nombre").val(especialidad.nombre);
	})
	
	$("#idTitulo").text("ACTUALIZAR ESPECIALIDAD");
...
$(document).on("click","#cerrar",function(){
	...
	$("#codigo").val("0");		
	$("#idTitulo").text("REGISTRAR ESPECIALIDAD");
